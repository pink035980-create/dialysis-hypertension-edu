...
# Optimized Vertical Layout (Shifted Up to absorb empty gap & keep player control safe zone)
panel_y = 150
badge_h = 54
badge_y = 92
card_y = 560
...
def render_frame_for_time(t):
    ...
    # Bottom Reminder Banner (Shifted Up to y=786~886)
    ...
    # Bilingual Subtitle Banner (Shifted Up to y=896~992, leaving 90px safe zone at bottom)
...
# Render sample image at t=10s
img_test = render_frame_for_time(10.0)
img_test.save(r"C:\Users\pink0\.gemini\antigravity\brain\4081544d-8f29-4771-854d-848e81c34012\vn_layout_shifted_up.png")
print("Saved shifted up frame test!")
